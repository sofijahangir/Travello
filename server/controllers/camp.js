...
const getRejectedCamps = async (req, res) => {
  try {
...
const getActiveCamps = async (req, res) => {
  try {
...
const getRecentCamps = async (req, res) => {
  try {
    const camps = await Camp.find({
      status_of_camp: 'Accepted',
      state_of_camp: 'Active',
...
const getTrendingCamps = async (req, res) => {
  try {
    const camps = await Camp.find({
      status_of_camp: 'Accepted',
      state_of_camp: 'Active',
...
const getInactiveCamps = async (req, res) => {
  try {
...
const markInactiveCamp = async (req, res) => {
  console.log(req.body.camp_name);
  try {
    if (!req.body.camp_name) {
      throw new Error('Enter Camp Name');
